...
label_description = tk.Label(root, text="Description:", bg="black", fg="white")
...
label_tasks = tk.Label(root, text="Tasks:", bg="black", fg="white")
label_tasks.grid(row=2, column=0, columnspan=3)

label_task_id = tk.Label(root, text="Enter Task ID to Delete:", bg="black", fg="white")
...
label_clock = tk.Label(root, text="", bg="black", fg="white")
